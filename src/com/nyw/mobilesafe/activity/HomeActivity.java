...
import com.nyw.mobilesafe.utils.MD5Utils;
...
public class HomeActivity extends Activity {
	...
	private int[] mPics = new int[] { R.drawable.home_safe,
			...
			R.drawable.home_tools, R.drawable.home_setting };
	...
	protected void showPasswordDialog() {
		// 判断是否设置密码
		String savsPassword = mPref.getString("password", null);
		if (!TextUtils.isEmpty(savsPassword)) {
	...
	private void showPasswordInputDialog() {
		...
		dialog.setView(view, 0, 0, 0, 0);// 设置变局为0保证在2.x的版本上运行没问题
